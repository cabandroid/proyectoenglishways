...
public class Level2 extends JPanel implements Runnable, KeyListener, ILimits, ActionListener {
    ...
    public Level2() {
        ...
        background = new ImageIcon(this.getClass().getResource("/img/Level2.png")).getImage().getScaledInstance(800, 600, Image.SCALE_AREA_AVERAGING);
        setLayout(null);
        ...
        n1.setBounds(new Rectangle(20, 410, 50, 60));
        n2.setBounds(new Rectangle(260, 250, 50, 60));
        n3.setBounds(new Rectangle(0, 140, 140, 50));
        n4.setBounds(new Rectangle(280, 30, 180, 50));
        n5.setBounds(new Rectangle(750, 360, 50, 600));
        n6.setBounds(new Rectangle(660, 360, 50, 600));
        n7.setBounds(new Rectangle(580, 360, 50, 600));
        n8.setBounds(new Rectangle(600, 410, 200, 50));
        n9.setBounds(new Rectangle(460, 410, 50, 60));
        //Dort
        d1.setBounds(new Rectangle(610, 360, 50, 50));
        d2.setBounds(new Rectangle(700, 360, 50, 50));
        //Stairs       
        e1.setBounds(new Rectangle(140, 330, 35, 170));
    ...
    public void paint(Graphics g) {
        ...
        g2.setRenderingHint(RenderingHints.KEY_ANTIALIASING, RenderingHints.VALUE_ANTIALIAS_ON);
        g2.drawString("What is \"Will\" used for?...", 300, 20);
        //respuestas
        g2.setColor(Color.getHSBColor(195, 100, 111));

        g2.drawString("Intentions,", 570, 360);
        g2.drawString("distant future", 570, 380);

        g2.drawString("Future plans,", 692, 360);
        g2.drawString("near future.", 692, 380);
    }
